...
# uncomment this line to run the brisque library here. 
# !pip install brisque
...
# The NIQE function codes. This is extracted from https://github.com/guptapraful/niqe.git
...
# Similarly for the PIQUE functions these are extracted from https://github.com/buyizhiyou/NRVQA.git
